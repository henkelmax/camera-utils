...
public class IntegerConfigValueSlider extends AbstractSliderButton {
    ...
    private ConfigBuilder.ConfigEntry<Integer> entry;
    private int min, max;
    private Function<Integer, Component> text;

    public IntegerConfigValueSlider(int x, int y, int width, int height, ConfigBuilder.ConfigEntry<Integer> entry, int min, int max, Function<Integer, Component> text) {
